...
* addManyUsers <количество пользователей> - генерация указанного колиличества пользователей и логинами "u<i>" и случайным
                                            рангом
* emulate <количество пользователей> - эмуляция заполнения очереди пользователями, 10 потоков осуществляют генерацию
                                       пользователей с логинами "u<i>", случайным рангом и случайной задежкой
